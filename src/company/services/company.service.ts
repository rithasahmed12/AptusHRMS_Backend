...
export class CompanyService {
  ...
  async verifyOTP(tenantId: string, domain: string, body: { email: string, otpString: string }) {
    try {
  ...
  async changePassword(tenantId: string, domain: string, body: { email: string, newPassword: string }) {
    try {
